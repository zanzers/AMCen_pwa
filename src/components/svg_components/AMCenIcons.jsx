export default function AMCenLogo({ width}) {
  return (
   <svg width={width ? "60" : "102" } height= "122" viewBox="0 0 107 122" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M25.042 112.95C25.7669 114.528 28.0192 114.496 28.6992 112.898L47.791 68.0332C48.3523 66.7142 47.3846 65.2503 45.9512 65.25H6.24023C4.78232 65.2502 3.81427 66.7602 4.42285 68.085L25.042 112.95Z" stroke="black" stroke-width="4"/>
    </svg>
